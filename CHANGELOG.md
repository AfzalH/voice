...
### Changed
- The iPhone and Android links moved into the Settings save bar as proper store buttons with the App Store and Google Play marks.
...
[3.6.1]: https://github.com/AfzalH/voice/releases/tag/v3.6.1
